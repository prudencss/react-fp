...
const numberListData = [Number(Math.E), Number(Math.PI), Number(Math.sqrt(2))];

interface ListProps extends IListProps {
  label: string;
}

export class ListVariation extends React.Component<
  { listPropsList: PropsWithChildren<ListProps>[] },
  object
> {
  render() {
...
const Template: Story<{ listPropsList: ListProps[] }> = (args) => (
  <ListVariation {...args} />
);
const args = {
  ...
  listPropsList: [
    {
      ...args,
      listData: stringListData,
      icon: EFaRegularIcons.Smile,
      label: "Smile Icon Variation",
    },
    {
      ...args,
      listData: numberListData,
      icon: EFaRegularIcons.Flag,
      label: "Flag Icon Variation",
    },
    {
      ...args,
      listData: dateListData,
      icon: EFaBrandsIcons.GooglePlay,
      label: "Google Play Brand Icon Variation",
    },
  ],
};
  ...
  listPropsList: [
    {
      ...
      listData: stringListData,
      icon: EFaRegularIcons.Smile,
      label: "Smile Icon Variation with alternate selected Icon",
      iconSelected: EFaRegularIcons.SmileWink,
    },
    {
      ...args,
      listData: numberListData,
      icon: EFaRegularIcons.Flag,
      label: "Flag Icon Variation with alternate selected Icon",
      iconSelected: EFaRegularIcons.Bell,
    },
    {
      ...args,
      listData: dateListData,
      icon: EFaBrandsIcons.GooglePlay,
      label: "Google Play Brand Icon Variation with alternate selected Icon",
      iconSelected: EFaBrandsIcons.Gg,
    },
  ],
};
